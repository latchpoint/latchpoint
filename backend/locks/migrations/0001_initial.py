...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="doorcode",
            index=models.Index(
                condition=models.Q(("is_active", True)), fields=["user"], name="door_codes_active_user_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="doorcode",
            index=models.Index(
                condition=models.Q(("end_at__isnull", False)), fields=["end_at"], name="door_codes_end_at_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="doorcode",
            constraint=models.CheckConstraint(
                condition=models.Q(("pin_length__gte", 4), ("pin_length__lte", 8)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("days_of_week__isnull", True),
                    models.Q(("days_of_week__gte", 0), ("days_of_week__lte", 127)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            model_name="doorcode",
            constraint=models.CheckConstraint(
                condition=models.Q(("uses_count__gte", 0)), name="door_codes_uses_count_gte_0"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("door_code", "lock_entity_id"), name="door_code_lock_assignments_unique_code_lock"
            ),
        ),
    ]
