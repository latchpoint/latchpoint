...
class LockConfigSyncApiTests(EncryptionTestMixin, APITestCase):
    def setUp(self):
        ...
        # Enable ZWaveJS in DB (replaces env var patches)
        ...
        entry.set_value_with_encryption({"enabled": True, "ws_url": "ws://example.invalid:3000"})
